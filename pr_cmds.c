...
{
	float	v;
	int	i;	// Slot Zero 3.50-1  Added this.
...
#endif	// Slot Zero 3.50-2  Added this.
...
PF_strftime,	// void(string format) strftime		= #5;	// Slot Zero 3.50-1  Built-in function strftime.
...
// Slot Zero 3.50-2  Added sin(), cos(), and sqrt(). (7 lines)
PF_sin,
PF_cos,
PF_sqrt,
